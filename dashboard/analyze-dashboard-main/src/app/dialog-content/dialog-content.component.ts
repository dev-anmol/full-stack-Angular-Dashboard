...
export class DialogContentComponent {
  ...
  parameters: string[] = [
    ...
    'PF', 'PF1', 'PF2', 'PF3',
    'THDi1', 'THDi2', 'THDi3',
    'THDin', 'THDig', 'TDD', 'THDv12',
    'THDv23', 'THDv31', 'THDv1',
    'THDv2', 'THDv3', 'THDvln',
    'VLN_Unbalanced', 'Present_Demand_KW',
    'Present_Demand_KVA', 'Present_Demand_KVAr',
    'Peak_Demand_KW', 'Peak_Demand_KVA',
    'Peak_Demand_KVAr', 'KWh_Received',
    'KVARh_Received', 'KVAh_Received'
  ];
